...
class MusicDataLoader(object):
  ...
  def get_batch(self, batchsize, songlength, part='train', variable_ticks=False):
    ...
    if self.songs[part]:
      ...
      num_song_features = len(batch[0][2][0])-2
  ...
  def get_num_song_features(self):
    return len(self.songs['train'][0][2][0])-2
